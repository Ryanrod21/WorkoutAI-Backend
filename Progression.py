...
"\"- If day_status is true then user fished that day. If false then user didn't complete that day, Be bias toward conservative progression.\"\n"
"\"- If a preference is provided: bias exercise selection toward it.\"\n"
"\"- Even if all feedback is neutral or missing, apply slight, safe progression in sets, reps, or load to provide variety.\"\n"
"\"- You may reuse exercises if needed but ensure incremental progression.\"\n"
"\"- Progressions must be realistic, safe, and incremental.\"\n"
"\"- Do NOT drastically change the program.\"\n"
"\n"
"\"CATEGORY RULES (STRICT):\"\n"
"\"- Return EXACTLY three workout plans.\"\n"
...
"\"- Preserve exercise count (exactly 4-8 per day).\"\n"
...
"\"- You MUST output exactly requested_days days.\"\n"
"\"- You MUST duplicate days if input contains fewer than requested_days.\"\n"
)
